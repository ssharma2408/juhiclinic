            ...
            <div class="card-box">
                ...
                <div class="mb-4 text-center">
                    <div class="btn-group" role="group">
                        <a href="{{ route('patient.login.show') }}" type="button"
                            class="btn btn-primary btn-rounded">Patient Login</a>
                        <a href="{{ route('patient.register.show') }}" type="button"
                            class="btn btn-secondary btn-rounded">Patient Register</a>
                    </div>
                </div>
                <form method="post" action="{{ route('patient.register.save') }}" class="contact-form-inner">
                    ...
                    <div class="single-input-wrap form-group mb-3">
                        ...
                        <input id="name" class="form-control" type="text" name="name" value="{{ old('name') }}"
                            placeholder="" required="required" autocomplete="name" autofocus>
                    </div>
                    @if ($errors->has('name'))
                    ...
                    <div class="single-input-wrap form-group mb-3">
                        ...
                        <div class="input-box" style="position: relative;">
                            ...
                            <input id="mobile_no" class="form-control ps-5" type="text" name="mobile_no"
