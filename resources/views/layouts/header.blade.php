    ...
    <div class="container">
      ...
      <div class="dropdown-menu">
       <a class="dropdown-item" href="{{ route('login.logout') }}">Logout</a>
                            ...
                            <a class="btn btn-secondary" href="{{ route('login.logout') }}"> <i
                                    class="ri-logout-circle-line"></i> Logout</a>
                        @else
                            <!-- <a href="{{ route('login.show') }}" class="btn btn-secondary ">
                                <i class="ri-login-circle-line me-2"></i>Login</a> -->
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{ route('login.show') }}">Doctor / Staff login</a>
                            </div>
                        @endif
                    </li>
                </ul>
